...
## 版本
目前版本：`v2026.09.v06`。前台與後台網頁皆顯示版本號；後續更新依 `YYYY.MM.vDD`，同日多版再加 `-1`、`-2`。


## 2026.09.v06-1 版面調整
- 移除前台上方／固定位置的版本膠囊。
- 前台頁尾原「© 2026 . GitHub Pages 網頁版」改為「© v2026.09.v06-1」。
- 版本號不再鎖定顯示於畫面上方，改放在網頁最下方頁尾。


## 2026.09.v06-2
修正前台：完整移除頁面上方固定的 `v2026.09` 綠色版本標籤，版本僅保留於最下方 footer：`© v2026.09.v06-2`。


## 2026.09.v06-3 簡潔視覺優化
- 前台版面改為更簡潔的卡片與留白配置。
- 統一背景、邊框、輸入框與標題視覺層級。
- 需注意事項使用暖黃色警示區塊加強辨識。
