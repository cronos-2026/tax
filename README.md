...
## 版本號
版本採 `vYYYY.MM`，例如 `2026.09.v06-19`。
...
# TAX FINAL 2026.09.v06-19 — 實際 GitHub Pages 部署設定
...
## 版本
目前版本：`2026.09.v06-19`。前台與後台網頁皆顯示版本號；後續更新依 `YYYY.MM.vDD`，同日多版再加 `-1`、`-2`。


## 2026.09.v06-19 版面調整
- 移除前台上方／固定位置的版本膠囊。
- 前台頁尾原「© 2026 . GitHub Pages 網頁版」改為「© 2026.09.v06-19」。
- 版本號不再鎖定顯示於畫面上方，改放在網頁最下方頁尾。


## 2026.09.v06-19
修正前台：完整移除頁面上方固定的 `2026.09.v06-19` 綠色版本標籤，版本僅保留於最下方 footer：`© 2026.09.v06-19`。


## 2026.09.v06-19 簡潔視覺優化
- 前台版面改為更簡潔的卡片與留白配置。
- 統一背景、邊框、輸入框與標題視覺層級。
- 需注意事項使用暖黃色警示區塊加強辨識。
...
## 2026.09.v06-19 版本編碼優化
- 版本格式統一為：`年.月.v日-次數`
- 本版版本號：`2026.09.v06-19`
- 年份前不再加 `v`
- 前台、後台、頁尾、README 與 ZIP 檔名同步使用相同格式


## 2026.09.v06-19 列印空白頁修正
...
## 2026.09.v06-19 後台版本格式修正
- 後台「網站版本」統一顯示為 `2026.09.v06-19`。
- 年份前不加 `v`。
- 格式固定為：`年.月.v日-次數`。
